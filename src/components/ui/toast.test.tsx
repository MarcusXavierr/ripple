...
describe("toast", () => {
  ...
  it("renders info toast at top-right with accent stripe and progress bar", () => {
    ...
    expect(screen.getByTestId("toast-badge-info")).toBeInTheDocument()
    expect(status.style.background).toContain("rgba(8, 18, 40")
  ...
  it("each variant uses correct accent and icon", () => {
    ...
    expect(screen.getByTestId("toast-badge-success")).toBeInTheDocument()
    expect(screen.getByTestId("toast-icon-success")).toBeInTheDocument()
    expect(screen.getByTestId("toast-badge-warning")).toBeInTheDocument()
    expect(screen.getByTestId("toast-icon-warning")).toBeInTheDocument()
    expect(screen.getByTestId("toast-badge-error")).toBeInTheDocument()
